...
import PrintableKeepsakeClient from './PrintableKeepsakeClient';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Printable keepsake for ${data.recipient_name} | SendKindly`,
    description: `A printable collection of messages and memories for ${data.recipient_name}'s ${occasion}celebration.`,
  };
}
